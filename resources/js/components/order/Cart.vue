<template>
    <div class="card">
        ...
        <div :class="feedbackClass" class="alert" role="alert" v-if="feedback.message" v-text="feedback.message"></div>
        ...
        <div class="card-footer">
            <div>
                <button @click="order" class="btn btn-primary" id="cart-submit" type="submit">Bestellen</button>
            </div>
        </div>
    </div>
</template>
